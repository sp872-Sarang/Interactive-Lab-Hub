#Receives detection of a bus and serves up data
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(prog="Interface_Node.py", description="Receives detection of a bus and serves up data")
        ...
        while True:
            ...
            while nrf.data_ready():
                ...
                if len(payload) == 9 and payload[0] == 0x01:
                    ...
                    print(f'Bus Detected (1 - True)/(0 - False) : {values[1]}')
